  ...
  return (
    <div className="flex h-screen">
      <section className="m-auto text-2xl flex items-center flex-col gap-4">
        ...
        <p className="text-xs text-center">We&#39;ve sent you a verification link to your e-mail address. Click on the link to verify and continue accessing the private pages.</p>
